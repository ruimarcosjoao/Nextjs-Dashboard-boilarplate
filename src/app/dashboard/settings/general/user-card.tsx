...
// @ts-expect-error erro ao importar component
...
export default function UserCard(props: {
  ...
  const [_, setUa] = useState<UAParser.UAParserInstance | undefined>();
        ...
        {session?.user.emailVerified ? null : (
          <Alert>
            ...
            <AlertDescription className="text-muted-foreground">
              Por favor, verifique seu endereço de e-mail. Verifique sua caixa
              de entrada para o e-mail de verificação. Se você não recebeu o
              e-mail, clique no botão abaixo para reenviar. de entrada para o
              e-mail de verificação. Se você não recebeu o e-mail, clique no
